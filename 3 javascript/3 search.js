...
let secondHeaderLiArray = [secondHeaderLi1, secondHeaderLi2, secondHeaderLi3, secondHeaderLi4, secondHeaderLi5];
...
function headerArray(a){  // 함수에 인자값을 받아 쓰는걸로 조건에 따라 다르게 함수를 실행시킬 수 있음
  for(let i = 0; i < secondHeaderLiArray.length; i++){
